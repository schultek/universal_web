...
abstract class RTCConfiguration implements JSObject {
  ...
  set iceServers(JSArray<RTCIceServer> value) {
    unsupportedPlatformError();
  }
  ...
  JSArray<RTCCertificate> get certificates {
    unsupportedPlatformError();
  }

  set certificates(JSArray<RTCCertificate> value) {
    unsupportedPlatformError();
  }
  ...
  set iceCandidatePoolSize(int value) {
    unsupportedPlatformError();
  }
...
abstract class RTCPeerConnection implements EventTarget, JSObject {
  ...
  /// generated.
  static JSPromise<RTCCertificate> generateCertificate(
...
abstract class RTCRtpTransceiverInit implements JSObject {
  ...
  set streams(JSArray<MediaStream> value) {
    unsupportedPlatformError();
  }

  JSArray<RTCRtpEncodingParameters> get sendEncodings {
    unsupportedPlatformError();
  }

  set sendEncodings(JSArray<RTCRtpEncodingParameters> value) {
    unsupportedPlatformError();
  }
}
...
abstract class RTCRtpParameters implements JSObject {
  ...
  set headerExtensions(JSArray<RTCRtpHeaderExtensionParameters> value) {
    unsupportedPlatformError();
  }
  ...
  JSArray<RTCRtpCodecParameters> get codecs {
    unsupportedPlatformError();
  }

  set codecs(JSArray<RTCRtpCodecParameters> value) {
    unsupportedPlatformError();
  }
}
...
abstract class RTCRtpSendParameters implements RTCRtpParameters, JSObject {
  ...
  JSArray<RTCRtpEncodingParameters> get encodings {
    unsupportedPlatformError();
  }

  set encodings(JSArray<RTCRtpEncodingParameters> value) {
    unsupportedPlatformError();
  }
...
abstract class RTCRtpEncodingParameters
  ...
  set scaleResolutionDownBy(num value) {
    unsupportedPlatformError();
  }
...
abstract class RTCRtpCapabilities implements JSObject {
  ...
  set codecs(JSArray<RTCRtpCodec> value) {
    unsupportedPlatformError();
  }

  JSArray<RTCRtpHeaderExtensionCapability> get headerExtensions {
    unsupportedPlatformError();
  }

  set headerExtensions(JSArray<RTCRtpHeaderExtensionCapability> value) {
    unsupportedPlatformError();
  }
}
